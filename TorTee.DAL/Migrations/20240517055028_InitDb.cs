        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_AspNetUsers_MenteeId",
                        column: x => x.MenteeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenteePlans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenteePlans_AspNetUsers_MentorId",
                        column: x => x.MentorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MenteePlanId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenteeApplications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenteeApplications_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenteeApplications_MenteePlans_MenteePlanId",
                        column: x => x.MenteePlanId,
                        principalTable: "MenteePlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingCalls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookingCalls_AspNetUsers_MenteeId",
                        column: x => x.MenteeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingCalls_Sessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                name: "MenteeApplicationAnswers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ResponseContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuestionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MenteeApplicationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenteeApplicationAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenteeApplicationAnswers_ApplicationQuestion_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "ApplicationQuestion",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenteeApplicationAnswers_MenteeApplications_MenteeApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_MenteeApplications_MenteeApplicationId",
                        column: x => x.MenteeApplicationId,
                        principalTable: "MenteeApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingCalls_MenteeId",
                table: "BookingCalls",
                column: "MenteeId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingCalls_SessionId",
                table: "BookingCalls",
                column: "SessionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenteeApplicationAnswers_MenteeApplicationId",
                table: "MenteeApplicationAnswers",
                column: "MenteeApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_MenteeApplicationAnswers_QuestionId",
                table: "MenteeApplicationAnswers",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_MenteeApplications_MenteePlanId",
                table: "MenteeApplications",
                column: "MenteePlanId");

            migrationBuilder.CreateIndex(
                name: "IX_MenteeApplications_UserId",
                table: "MenteeApplications",
                column: "UserId");
