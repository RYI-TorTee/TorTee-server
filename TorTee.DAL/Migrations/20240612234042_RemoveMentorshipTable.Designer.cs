...
namespace TorTee.DAL.Migrations
{
    ...
    [Migration("20240612234042_RemoveMentorshipTable")]
    partial class RemoveMentorshipTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TorTee.Core.Domains.Entities.ApplicationQuestion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d85a973e-825e-487e-b895-064782f4e1ca"),
                            Content = "What best describes the goal of your mentorship?"
                        },
                        new
                        {
                            Id = new Guid("f94b15f3-1973-4ce2-9fb4-54833efa7595"),
                            Content = "When would you like to reach that goal?"
                        },
                        new
                        {
                            Id = new Guid("e1b63328-5e56-4214-a00b-329930150c5a"),
